...
import 'package:nargilem/navBarPage/SettingPageFile/AromaPageFile/MixBrandPageFile/AddBrandToTheMix.dart';
import 'package:nargilem/navBarPage/SettingPageFile/AromaPageFile/MixBrandPageFile/CategoryOperations/CategoryManagementPage.dart';
...
class _TobaccoBlendsPageState extends State<TobaccoBlendsPage> with SingleTickerProviderStateMixin {
  ...
  Map<int, dynamic> blendCategories = {};
  ...
  void _handleSubmitted(String value) {
    if (_controllerBlendAdd.text.isNotEmpty) {
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => AddBrandToTheMix(name: _controllerBlendAdd.text),
        ),
      );
  ...
  void _openCategoryManagementPage(int blendId, String blendName) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => CategoryManagementPage(blendId: blendId, blendName: blendName),
      ),
    );
  }
                                      ...
                                      Row(
                                        children: [
                                          IconButton(
                                            ...
                                            icon: FaIcon(FontAwesomeIcons.trash, size: 18, color: Colors.white),
                                          ),
                                          IconButton(
                                            color: HexColor("#f3f4f6"),
                                            onPressed: () {
                                            ...
                                            icon: FaIcon(FontAwesomeIcons.penToSquare, size: 18, color: Colors.white),
                                          ),
                                          IconButton(
                                            color: HexColor("#f3f4f6"),
                                            onPressed: () {
                                              _openCategoryManagementPage(blendId, blend['name']);
                                            },
                                            icon: FaIcon(FontAwesomeIcons.listCheck, size: 18, color: Colors.white),
                                          ),
                                        ],
                                      ),
                                    ],
                                        ...
                                        Padding(
                                          ...
                                          child: blendIngredients.containsKey(blendId)
                                            ...
                                            itemBuilder: (context, ingredientIndex) {
                                              ...
                                              final ingredientName = availableIngredients.firstWhere((element) => element['id'] == ingredient['tobacco_id'], orElse: () => null);
                                              final ingredientId = ingredient['id'];
                                              if (ingredientName == null) return Container();
                                              return Card(
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      Text(
                                                        '${ingredientName['name']} - Oran: ${ingredient['rate']}',
                                                        style: TextStyle(color: HexColor("#f3f4f6")),
                                                        overflow: TextOverflow.ellipsis,
                                                      ),
                                                      Row(
                                                                  ...
                                                                  return Padding(
                                                                    ...
                                                                    child: Container(
                                                                      ...
                                                                      child: Column(
                                                                        ...
                                                                        children: [
                                                                          Text(
                                                                            "$ingredientName İçin Eklenecek Oranı Belirtin",
                                                                            style: const TextStyle(
                                                                              fontSize: 16.0,
                                                                              fontWeight: FontWeight.bold,
                                                                            ),
